...
class FakeDatabaseSpec extends FlatSpec with Matchers{
  /*val myTree = Branch(1, Branch(1, Leaf(2), Leaf(4)), Branch(5, Leaf(2), Leaf(3)))

  "fetchAllDonators" should "gives the name of all donators" in {
    FakeDatabase.fetchAllDonators() shouldEqual List
  }
